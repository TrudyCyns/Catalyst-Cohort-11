...
const val_business = ()=>{
    ...
    if (bizNameLen == 0 || bizNameLen < 5 || bizNameLen >= 25){
        bizName.style.backgroundColor = '#FEEAE8'
        par3.textContent = "Business name must have 5-25 characters!"
...
let val_street = () =>{
    ...
    if (streetLen == 0 || streetLen <= 10 || streetLen >= 20){
        bStreet.style.backgroundColor = '#FEEAE8'
        par6.textContent = "Business street must have 10-20 characters!"
